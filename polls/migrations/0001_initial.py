# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2018-04-16 06:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_param', jsonfield.fields.JSONField(default=dict)),
                ('real_Result', jsonfield.fields.JSONField(default=dict)),
                ('expected_result', jsonfield.fields.JSONField(default=dict)),
                ('pass_or_fail', models.BooleanField(default=None)),
                ('description', models.CharField(max_length=256)),
                ('on_going', models.BooleanField(default=True)),
                ('url', models.URLField(default='http://host:port/path?param')),
            ],
        ),
        migrations.CreateModel(
            name='TestProject',
